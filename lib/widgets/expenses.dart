...
class _ExpensesState extends State<Expenses> {
  ...
  void _addExpense(Expense expp) {
    setState(() {
      _registredExpenses.add(expp);
    }); //to force rebuild the widget to update the list of expenses
  }

  void _removeExpense(Expense expense) {
    final expenseIndex =
        _registredExpenses.indexOf(expense);
    setState(() {
